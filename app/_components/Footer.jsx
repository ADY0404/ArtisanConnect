        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <Link href="https://www.x.com" className="text-gray-400 hover:text-gray-500">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              <li><Link href="/terms-of-service" className="text-gray-500 hover:text-gray-900">Terms of Service</Link></li>
              <li><Link href="/privacy-policy" className="text-gray-500 hover:text-gray-900">Privacy Policy</Link></li>
              <li><Link href="/cookie-policy" className="text-gray-500 hover:text-gray-900">Cookie Policy</Link></li>
            </ul>
          </div>
