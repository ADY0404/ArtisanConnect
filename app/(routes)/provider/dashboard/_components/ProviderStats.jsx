              ...
              <div className="pt-2 sm:pt-3 border-t">
                ...
                <div className="space-y-1 sm:space-y-2 text-xs sm:text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{formatCurrency(thisMonthRevenue * 0.85)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Tips & Bonuses</span>
                    <span className="font-medium">{formatCurrency(thisMonthRevenue * 0.15)}</span>
                  </div>
                  <div className="flex justify-between pt-1 sm:pt-2 border-t">
                    <span className="text-gray-600">Platform Fee (15%)</span>
                    <span className="font-medium text-red-600">-{formatCurrency(thisMonthRevenue * 0.15)}</span>
                  </div>
                  <div className="flex justify-between font-bold">
                    <span>Net Earnings</span>
                    <span className="text-green-600">{formatCurrency(thisMonthRevenue * 0.85)}</span>
                  </div>
                </div>
              </div>
            </div>
