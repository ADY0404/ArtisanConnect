    ...
    <body>
        <div class="container">
            ...
            <div class="section">
                ...
                <div class="amount-breakdown">
                    ...
                    <div class="amount-row">
                        ...
                        <span>GHS ${commissionAmount.toFixed(2)}</span>
                    </div>
            ...
            <div class="payment-info">
                ...
                Please pay GHS ${totalAmount.toFixed(2)} directly to the service provider.
                This invoice serves as your receipt for the completed service.
            </div>
            ` : `
            <div class="payment-info">
                <strong>✅ Payment Completed</strong><br>
                Payment of GHS ${totalAmount.toFixed(2)} was successfully processed through the ArtisanConnect app.
